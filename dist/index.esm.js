...
//     binance: "#F0B90B",
// };
// // var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#252b64", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#00205b", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
...
//     bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
// } });
// var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", primaryDark: "#0098A1", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#00205b", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#000316", backgroundDisabled: "#e9eaeb", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#252b64", text: "#ffffff", textDisabled: "#bdc2c4", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#0d0f23", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#000316", backgroundDisabled: "#e9eaeb", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#252b64", text: "#ffffff", textDisabled: "#bdc2c4", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#0d0f23", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
